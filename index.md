...
- Deliver push notifications, if and when this feature ships and you opt in
...
**Access, correction, and deletion.** Because Outpost uses anonymous authentication, we have no way to identify you outside the app, and you have no account to log into. To request access to, correction of, or deletion of data tied to your anonymous user ID:

1. Email us at **outpostforfans@gmail.com**
2. To verify the data is yours, we may ask you to confirm details only the original submitter would know (e.g., specific bars or teams you've reviewed, or approximate dates of submissions).
3. We will respond within 14 days and complete verified requests within 30 days.

**Important note on uninstalling.** Deleting the Outpost app from your device does **not** automatically delete your contributed data from our database. Your anonymous user ID is preserved in iOS Keychain and will be restored if you reinstall Outpost on the same device. This preserves your contributions across reinstalls and prevents duplicate submissions. To delete contributed data, please contact us using the email above.
